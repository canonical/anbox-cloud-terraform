...
| <a name="input_registry_connection"></a> [registry\_connection](#input\_registry\_connection) | Object to represent connection details for connecting to anbox registry | <pre>object({<br/>    mode      = string<br/>    offer_url = string<br/>  })</pre> | `null` | no |
